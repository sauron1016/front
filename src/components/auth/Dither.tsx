...
const WrappedRetro = wrapEffect(RetroEffectImpl as any) as unknown as ComponentType<{
  colorNum?: number;
  pixelSize?: number;
}>;

const RetroEffect: ComponentType<{ colorNum?: number; pixelSize?: number }> = ({ colorNum, pixelSize }) => {
